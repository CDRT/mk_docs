...
1. Download from [Lenovo](https://download.lenovo.com/cdrt/tools/lcu-1.0.0.zip)
2. Extract the zip file and move the Lenovo.Client.Update folder to: `C:\Program Files\WindowsPowerShell\Modules\`
