...
!!! note "What happens if Dock Manager cannot reach the internet to download firmware?"
...
!!! note "How do I check the current firmware version of an attached dock?"
...
!!! note "Is Dock Manager supported on ARM-based devices?"
