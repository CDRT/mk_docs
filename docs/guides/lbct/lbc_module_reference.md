...
| Cmdlet | Purpose |
| --- | --- |
| [`Get-LnvSignedWmiCommand`](#get-lnvsignedwmicommand) | Generate signed WMI commands for BIOS operations |
| [`Submit-LnvBiosChange`](#submit-lnvbioschange) | Execute a signed WMI command on the device |
| [`Submit-LnvBiosConfigFile`](#submit-lnvbiosconfigfile) | Apply multiple signed commands from a file |
...
<a id="get-lnvsignedwmicommand"></a>
...
<a id="submit-lnvbiosconfigfile"></a>
...
<a id="convert-lnvbiosconfigfile"></a>
